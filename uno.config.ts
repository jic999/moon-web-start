...
export default defineConfig({
  shortcuts: {
    ...
    'btn': 'px-4 py-1 rounded inline-block bg-$primary-c text-white cursor-pointer hover:bg-$primary-c disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50',
