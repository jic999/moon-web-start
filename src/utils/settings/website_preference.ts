...
const websitePreferenceList: SettingItemChildren<WebsitePreference> = [
  { name: '自动', enName: 'Auto', value: 'Auto' },
  { name: '中国大陆', enName: 'Chinese Mainland', value: 'Chinese Mainland' },
  { name: '全球', enName: 'Global', value: 'Global' },
  { name: '自定义', enName: 'Customize', value: 'Customize' },
]
